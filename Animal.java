...
public abstract class Animal extends Entity
{
    ...
    enum AnimalStats {
        ...
        EAGLE(4, 0.324, 3, 3, 9, 21, 3, 3, 50, 40, 3),
        FROG(1, 0.35,  4, 2, 6, 21, 1, 1, 20, 8, 1),
        GAZELLE(2, 0.375, 3, 2, 6, 21, 2, 1, 30, 25, 1),
        LION(3, 0.2205,3, 2, 6, 21, 4, 3, 50, 55, 2),
        SNAKE(5, 0.128, 2, 2, 10, 16, 2, 2, 50, 60, 1);
